...
/**
 * RepositoryTestDebugProjectContainer.
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class RepositoryTestDebugProjectContainer extends Container
{
    private $parameters;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'feed.handler' => 'getFeed_HandlerService',
            'feed.manager' => 'getFeed_ManagerService',
            'feedio' => 'getFeedioService',
            'feedio.client' => 'getFeedio_ClientService',
    ...
    {
        return $this->services['debug.controller_resolver'] = new \Symfony\Component\HttpKernel\Controller\TraceableControllerResolver(new \Symfony\Bundle\FrameworkBundle\Controller\ControllerResolver($this, new \Symfony\Bundle\FrameworkBundle\Controller\ControllerNameParser($this->get('kernel')), $this->get('logger', ContainerInterface::NULL_ON_INVALID_REFERENCE)), $this->get('debug.stopwatch'));
    }
    ...
    {
        return $this->services['debug.debug_handlers_listener'] = new \Symfony\Component\HttpKernel\EventListener\DebugHandlersListener(NULL, $this->get('logger', ContainerInterface::NULL_ON_INVALID_REFERENCE), -4182, NULL, true, NULL);
    }
    ...
    {
        $this->services['debug.event_dispatcher'] = $instance = new \Symfony\Component\HttpKernel\Debug\TraceableEventDispatcher(new \Symfony\Component\EventDispatcher\ContainerAwareEventDispatcher($this), $this->get('debug.stopwatch'), $this->get('logger', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $b->addLogger(new \Symfony\Bridge\Doctrine\Logger\DbalLogger($this->get('logger', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('debug.stopwatch', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'feeds_test', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $c, $f, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[4].'/Entity'))), 'FeedBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('FeedBundle' => 'FeedBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_542bd57fe2a9477dfb72b13443cb51f8814bd9b0c98f3099c883bd6e5364406a');
    ...
    /**
     * Gets the 'feed.handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FeedBundle\Handler\FeedHandler A FeedBundle\Handler\FeedHandler instance
     */
    protected function getFeed_HandlerService()
    {
        return $this->services['feed.handler'] = new \FeedBundle\Handler\FeedHandler($this->get('feedio'), $this->get('doctrine.orm.default_entity_manager'), 10, $this->get('feed.manager'));
    }

    /**
     * Gets the 'feed.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     *
     * @return \FeedBundle\Utils\FeedEntityManager A FeedBundle\Utils\FeedEntityManager instance
     */
    protected function getFeed_ManagerService()
    {
        return $this->services['feed.manager'] = new \FeedBundle\Utils\FeedEntityManager($this->get('doctrine.orm.default_entity_manager'), new \Doctrine\Common\Collections\ArrayCollection());
    }

    /**
     * Gets the 'feedio' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FeedIo\FeedIo A FeedIo\FeedIo instance
     */
    protected function getFeedioService()
    {
        return $this->services['feedio'] = new \FeedIo\FeedIo($this->get('feedio.client'), $this->get('logger'));
    }

    /**
     * Gets the 'feedio.client' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FeedIo\Adapter\Guzzle\Client A FeedIo\Adapter\Guzzle\Client instance
     */
    protected function getFeedio_ClientService()
    {
        return $this->services['feedio.client'] = new \FeedIo\Adapter\Guzzle\Client($this->get('guzzle.client'));
    }
    ...
    {
        return $this->services['guzzle.client'] = new \GuzzleHttp\Client();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Psr\Log\NullLogger A Psr\Log\NullLogger instance
     */
    protected function getLoggerService()
    {
        return $this->services['logger'] = new \Psr\Log\NullLogger();
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FeedBundle' => 'FeedBundle\\FeedBundle',
            ),
            'kernel.bundles_metadata' => array(
                ...
                'DebrilRssAtomBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[4].'/vendor/debril/rss-atom-bundle/Debril/RssAtomBundle'),
            ...
            'kernel.container_class' => 'RepositoryTestDebugProjectContainer',
            'database_host' => 'localhost',
            'database_port' => NULL,
            'database_name' => 'feeds_test',
            'database_user' => 'root',
            ...
            'debug.container.dump' => (__DIR__.'/RepositoryTestDebugProjectContainer.xml'),
